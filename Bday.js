alert("It's simple but I hope u like it!🤗  Tqq for watching!")
alert("Umm!now Click Ok and Tap anywhere to smile :)")
var force;
var firework =[] ;
function setup(){
...
window.onload =()=>{
    ...
    request.open('GET', 'https://mobcup.net/d/p2inbsfg/mp3', true); 
